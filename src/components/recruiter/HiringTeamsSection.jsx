...
export default function HiringTeamsSection() {
  return (
    <section className="bg-[#FFFFFF] py-18 overflow-hidden">
      ...
      <div className="w-536px px-[200px]">
        <div className="grid grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col">
            ...
            <div>
              <h2
                className="text-[48px] leading-[0.98] tracking-[-1px] font-[700] text-left"
              ...
              <p
                className="mt-2 text-[18px] text-[#6B6B6B] font-medium text-left"
                style={{ fontFamily: "Figtree, sans-serif" }}
              >
           ...
           <div className="mt-10 flex-1 bg-white border-[2px] border-[#631FEE] rounded-[28px] px-12 py-14 min-h-[700px] shadow-[6px_8px_0px_#6D28FF] flex flex-col justify-center">
          ...
          <div className="space-y-10">
            ...
            {/* CARD 1 */}
           <div className="bg-white border-[2px] border-[#FF5A0A] rounded-[28px] px-8 py-8 h-[700px] shadow-[6px_8px_0px_#FF5A0A]">
              <h3
                className="text-[32px] leading-[1.1] font-[600] text-[#111111]"
                style={{ fontFamily: "Figtree, sans-serif" }}
              >
            ...
            {/* CARD 2 */}
           <div className="bg-white border-[2px] border-[#FF5A0A] rounded-[28px] px-12 pt-[50px] pb-[50px] min-h-[760px] shadow-[6px_8px_0px_#FF5A0A] flex flex-col justify-center">
              <h3
                className="text-[32px] leading-[1.1] font-[600] text-[#111111]"
                style={{ fontFamily: "Figtree, sans-serif" }}
              >
